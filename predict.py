...
if __name__ == '__main__':
    ...
    parser.add_argument('checkpoint_dir', type=str, help='Positional argument for the model weights checkpoint, such as: "./checkpoints/training/cp-000.ckpt". Make sure to not include ".data-00000-of-00001" in the path.')
